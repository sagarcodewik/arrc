...
import { useLevelUpCalc } from "./useLevelUpCalc";
          ...
          <div className="flex flex-col items-center justify-center gap-10">
            <div className="relative w-full max-w-[800px] px-4 flex flex-col items-center">
              <div className="relative w-full flex flex-col gap-4 lg:gap-6">
                ...
                <span className="absolute -left-48 -top-40 text-4xl text-cyan-400/30">
                  ●
                </span>
                <span className="absolute left-48 -top-44 text-3xl text-cyan-400/30">
                  ■
                </span>
                <span className="absolute -left-48 top-44 text-3xl text-cyan-400/30">
                  ◆
                </span>
                <span className="absolute left-48 top-48 text-4xl text-cyan-400/30">
                  ▲
                </span>
                <span className="absolute -top-52 text-2xl text-cyan-400/30">
                  ◉
                </span>
                <span className="absolute top-52 text-3xl text-cyan-400/30">
                  ◊
                </span>
                ...
                <div className="relative top-12 flex min-h-[220px] w-full items-center justify-center overflow-hidden rounded-3xl bg-gradient-to-br from-white/95 to-sky-100/95 p-8 shadow-2xl backdrop-blur-xl">
                  <img
                    src="https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/68a2b6e7e9a803fb92318e56/b38fb9264_Screenshot2025-11-05at122531AM.png"
                    alt="Wealth illustration"
                    className="absolute inset-0 h-full w-full rounded-3xl object-cover opacity-[0.08] grayscale blur-sm"
                  />
                  ...
                  <h2
                    key={index}
                    className="relative z-10 text-center text-xl sm:text-2xl md:text-3xl font-bold tracking-tight text-transparent bg-clip-text bg-gradient-to-br from-sky-900 via-sky-500 to-sky-900 animate-fade-slide"
                  >
                    {quotes[index]}
                  </h2>
              ...
              <div className="text-center space-y-2 px-4 mt-20">
                <h1 className="font-serif text-3xl sm:text-4xl lg:text-5xl font-bold text-slate-800">
                  Time Value of Money
                </h1>
            ...
            <div className="max-w-2xl rounded-lg border border-slate-200 bg-white/90 p-4 shadow-md backdrop-blur-sm text-center z-40">
              <p className="font-serif text-sm italic text-slate-700 sm:text-base">
                “An investment in knowledge pays the best interest.”{" "}
                <span className="not-italic font-semibold text-slate-900 block">
                  — Benjamin Franklin
                </span>
              </p>
            </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-2 gap-4 lg:gap-6 p-4 lg:p-6 h-full rounded-2xl bg-white/95 border border-slate-200 shadow-xl hover:shadow-2xl transition-all duration-500">
              ...
              <form className="space-y-4">
                ...
                <div className="space-y-4 bg-slate-50 p-3 sm:p-4 rounded-xl border border-slate-200">
                  <label className="flex items-center gap-2 text-sm text-black">
                    ...
                    Regular Contribution (Savings Habit)
                  </label>
                  ...
                  <div>
                    ...
                    <span className="text-xs">
                      ⭐ This represents your smart financial habit!
                    </span>
                  </div>
                </div>
                ...
                <div>
                  <Input
                    ...
                    value={rate}
                    onChange={(e) =>
                      allowOnlyNumber(e.target.value) && setRate(e.target.value)
                    }
                  />
                  <span className="text-xs">
                    The expected yearly return (e.g., 7 for 7%).
                  </span>
                </div>
                ...
                <div>
                  ...
                  />
                  <span className="text-xs">
                    The longer the time, the greater the impact of compounding.
                  </span>
                </div>
                ...
                <div>
                  ...
                  />
                  <span className="text-xs">
                    This affects how often interest is calculated.
                  </span>
                </div>
              </form>
            </div>
            ...
            <div className="bg-slate-50 border border-slate-200 rounded-2xl">
              ...
              <div className="grid sm:grid-cols-2 gap-4 p-4">
                ...
                <div className="rounded-xl p-4 bg-white border shadow">
                  <h3 className="text-xl font-semibold mb-1">Total Invested</h3>
                  <p className="text-lg font-medium">
                    $
              ...
              <div className="p-4 w-full flex flex-col gap-4">
                ...
                <div className="bg-sky-50/70 border border-sky-200/50 rounded-xl p-3 lg:p-4">
                  ...
                  <p className="text-xs lg:text-sm text-sky-700">
                    {totalInvested > 0
                      ? "You're utilizing two powerful tools! Your lump sum gave you a head start, and your regular contributions ensure consistent, long-term growth. Keep up the habit! 🎯"
                      : "Start by entering your investment details to see how powerful consistent habits can be. 🚀"}
                  </p>
                </div>
                ...
                <div className="bg-sky-50/70 border border-sky-200/50 rounded-xl p-3 lg:p-4">
                  ...
                  <div className="flex justify-between text-sm mb-1">
                    <p>Interest from Lump Sum:</p>
                    <p>
                      $
                      {interestPV.toLocaleString(undefined, {
                        maximumFractionDigits: 2,
                      })}
                    </p>
                  </div>
                  ...
                  <div className="flex justify-between text-sm">
                    <p>Interest from Contributions:</p>
                    <p>
                      $
                      {interestPMT.toLocaleString(undefined, {
                        maximumFractionDigits: 2,
                      })}
                    </p>
                  </div>
        ...
        <Section customClass="relative mb-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6">
            <div className="group rounded-xl text-card-foreground p-4 lg:p-6 bg-white/95 backdrop-blur-sm border border-slate-200/50 shadow-lg hover:shadow-xl hover:scale-102 transition-all duration-300">
              <h3 className="text-xl font-semibold tracking-tight text-gray-900 line-clamp-1 mb-1">
                💰 Two Streams Win
              </h3>
              <p className="text-sm font-medium text-black line-clamp-1">
                Combine a lump sum investment with regular monthly contributions
                to create a powerful wealth-building engine!
              </p>
            </div>
            <div className="group rounded-xl text-card-foreground p-4 lg:p-6 bg-white/95 backdrop-blur-sm border border-slate-200/50 shadow-lg hover:shadow-xl hover:scale-102 transition-all duration-300">
              <h3 className="text-xl font-semibold tracking-tight text-gray-900 line-clamp-1 mb-1">
              ...
              <p className="text-sm font-medium text-black line-clamp-1">
                Even a $100/month habit can grow into substantial wealth over
                time. Small, consistent actions lead to extraordinary results!
              </p>
            </div>
            <div className="group rounded-xl text-card-foreground p-4 lg:p-6 bg-white/95 backdrop-blur-sm border border-slate-200/50 shadow-lg hover:shadow-xl hover:scale-102 transition-all duration-300">
              <h3 className="text-xl font-semibold tracking-tight text-gray-900 line-clamp-1 mb-1">
