...
import { CircleCheckBig, Plus, Sparkles, Trash2, Zap } from "lucide-react";
        ...
        <Section customClass="relative mb-6">
          <div className="flex flex-col-reverse md:flex-row md:justify-between md:items-start gap-4 w-full">
            ...
            <div className="text-center md:text-left">
              <h1 className="text-slate-900 text-2xl sm:text-3xl lg:text-3xl font-semibold">Linked Accounts</h1>
              <p className="text-slate-600 text-sm sm:text-base font-medium">Manage your ARRC investment accounts</p>
            </div>
            </div>
            <div className="flex gap-2 items-center justify-center md:justify-end mt-4 md:mt-0 w-full md:w-auto">
             <Button variant="outline" size="default" rounded="lg" type="button" className="inline-flex items-center justify-center gap-2 whitespace-nowrap"><Zap size={18} className="flex-shrink-0"/> <span>Sync Balances</span></Button>
             <Button variant="gradientCyanSky" size="default" rounded="lg" type="button" className="inline-flex items-center justify-center gap-2 whitespace-nowrap" onClick={(e) => {e.preventDefault(); setOpenAccountModal(true);}}><Plus size={18} className="flex-shrink-0"/> <span>Connect Account</span></Button>
            </div>
          </div>
        </Section>
      </AnimateSection>
